...
const About = () => {
  return (
    <div id="about" className="bg-stone-50 text-stone-800">

      {/* HERO */}
      <section className="bg-[#4a6741] py-14 md:py-20 px-4 text-center text-white">
      ...
      {/* STORY */}
      <section className="max-w-6xl mx-auto py-12 md:py-20 px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">

        {/* TEXT */}
        <div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-5 md:mb-6 text-[#4a6741]">
      ...
      {/* VALUES */}
      <section className="bg-white py-12 md:py-20 px-4 sm:px-6 border-y border-stone-200">

        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 text-center">

          {['Purity', 'Harmony', 'Excellence'].map((value) => (
            <div key={value} className="px-2">
              <h3 className="text-xl md:text-2xl font-bold text-[#4a6741] mb-3 md:mb-4">
                {value}
              </h3>
