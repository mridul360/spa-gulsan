      ...
      <Container>
        <nav className="flex items-center justify-between h-[70px] px-4 md:px-8">
          ...
          <button
            ...
            className="hidden md:block bg-[#3a5c3a] text-white px-5 py-2 rounded-full text-xs uppercase tracking-widest"
          >
            Book Session
          </button>
        ...
        {menuOpen && (
          <div className="md:hidden flex flex-col gap-2 px-4 pb-4 bg-white border-t">
            ...
            <button
              onClick={() => handleScroll("booking", "Booking")}
              className="bg-[#3a5c3a] text-white px-5 py-2 rounded-full text-sm uppercase tracking-widest mt-2"
            >
              Book Session
            </button>
          </div>
